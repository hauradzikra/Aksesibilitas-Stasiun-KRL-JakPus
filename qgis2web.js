...
map.getView().fit([11874424.132501, -702937.918613, 11911001.184838, -679088.269944], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Analisis Aksesibilitas Stasiun KRL di Jakarta Pusat</h2>';
        return titleElement;
    })(),
